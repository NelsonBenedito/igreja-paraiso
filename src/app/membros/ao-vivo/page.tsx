            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div>
                        ...
                        <p className="text-slate-500 dark:text-slate-300 mt-2">Assista nossos cultos e estudos bíblicos em tempo real.</p>
                    </div>
                ...
                {!live && (
                    <div className="mb-12 bg-white dark:bg-paraiso-blue border border-slate-100 dark:border-white/10 p-8 rounded-[2.5rem] flex flex-col md:flex-row items-center gap-6 shadow-sm overflow-hidden relative">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h3 className="text-xl font-black text-slate-800 dark:text-white tracking-tight">Não estamos ao vivo no momento</h3>
                            <p className="text-slate-500 dark:text-slate-300 text-sm mt-1">Aproveite para assistir nossas últimas celebrações e estudos bíblicos logo abaixo.</p>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white dark:bg-paraiso-blue p-8 rounded-[2.5rem] border border-slate-100 dark:border-white/10 shadow-sm relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h2 className="text-2xl md:text-3xl font-black text-paraiso-blue-dark dark:text-white tracking-tighter leading-tight mb-4">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {otherVideos.length > 0 ? otherVideos.map((vid: any, i: number) => (
                                <a
                                    ...
                                    className="group flex gap-4 p-4 rounded-3xl hover:bg-white dark:hover:bg-paraiso-blue hover:shadow-md transition-all border border-transparent hover:border-slate-100 dark:hover:border-white/10"
                                >
                                    ...
                                    <div className="flex flex-col justify-center min-w-0">
                                        <h4 className="text-sm font-bold text-slate-800 dark:text-white line-clamp-2 leading-snug group-hover:text-paraiso-blue-dark dark:group-hover:text-paraiso-green transition-colors">
                                            {vid.snippet.title}
                                        </h4>
                        ...
                        <Link
                            href="https://youtube.com/@paraisoigreja"
                            target="_blank"
                            className="block w-full text-center py-5 rounded-3xl border-2 border-dashed border-slate-200 dark:border-white/20 text-slate-400 dark:text-slate-400 font-black uppercase tracking-widest text-[10px] hover:border-red-600 hover:text-red-600 transition-all"
                        >
